 ...
 */
final readonly class LocalDateTimeRange implements Range
{
    use RefTrait;
     ...
     * ```
     */
    public function contains(self|LocalDateTime $other): bool
    {
     ...
     * ```
     */
    public function isBefore(self|LocalDateTime $other): bool
    {
     ...
     * ```
     */
    public function isAfter(self|LocalDateTime $other): bool
    {
    ...
    /**
     * Obtains an instance of `ZonedDateTimeRange` with a given timezone.
     */
    ...
    /**
     * Obtains an instance of `DateRange` from this range.
     */
